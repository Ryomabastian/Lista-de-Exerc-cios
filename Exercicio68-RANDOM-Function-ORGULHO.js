...
if (ArrayDeEscolha.includes(key)) {
    ...
    //     switch (newkey) {
    //         case 'cerveja':
    //             final[key-1].Preco = final[key-1].Preco +10
    //             break;
    //         case 'suco':
    //             final[key-1].Preco = final[key-1].Preco +8
    //             break;
    //         case 'agua':
    //             final[key-1].Preco = final[key-1].Preco +5
    //             break;
    //         case 'pizza':
    //             final[key-1].Preco = final[key-1].Preco +12
    //             break;
    //         case 'hamburguer':
    //             final[key-1].Preco = final[key-1].Preco +15
    //             break;
    //         case 'nada':
    //             final[key-1].Preco = final[key-1].Preco
    //             break;
    //     }
    while (newkey!= 'nada') {
...
///MELHORIAS> Se escrever com Maiusculo nao funciona/ 
//Escrever algo que nao existe deveria voltar a opção de novo.
//Opção de clicar ao inves de escrever no terminal